...
func NewRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.RegisterResource("clickhousedbops:index/role:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("clickhousedbops:index/role:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// This field must be left null when using a ClickHouse Cloud cluster.
// When using a self hosted ClickHouse instance, this field should only be set when there is more than one replica and you are not using 'replicated' storage for user_directory.
func (o RoleOutput) ClusterName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Role) pulumi.StringPtrOutput { return v.ClusterName }).(pulumi.StringPtrOutput)
}
